        ...
        :Application(w,h)
{
	...
	//   - Beide Arrays sind bereits groß genug für einen vierten Punkt (siehe U_FourPoints.h).
	//   - Denken Sie an F12 zur Erkundung der Codebase.
	// ...

	// U01 A2)
	context.clearColor.set(0.5f,0.0f,0.0f,1.0f);
...
void App_FourPoints::program_step()
{
	...
	context.drawArrays(CG_POINTS,0,3);
}
